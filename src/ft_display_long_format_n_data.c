...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_display_long_format_n_data.c                    :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tel-bouh <tariqelbouhali039@gmail.com>     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/06 18:01:51 by tel-bouh          #+#    #+#             */
/*   Updated: 2026/06/06 19:15:08 by tel-bouh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "./ft_ls.h"

static t_long_format	*ft_skip_long_n(t_long_format *tmp, int len, int *i)
{
	while (tmp && *i < len)
	{
		(*i)++;
